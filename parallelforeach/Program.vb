...
Module Program
    ...
    Public Class Program
        Public Shared Sub Main()
            ...
            'CreateTestObject()
            app3D.CreateTestObject()

            ' Iterate through the list using a For Each loop and print each tuple
            Console.WriteLine("Printing contents of myTupleList:")
            For Each tuple In myTupleList
